'''
setup.py — Install CoEv2 Console on a new machine.
...
def run_install(args):
    ...
    if wait_healthy(health_url):
        print(_GREEN("\nCoEv2 Console is up and healthy."))
        print(f"\nNext steps:")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CoEv2 Console installer")
